...
/**
 * Custom input for internationalized array fields of type `internationalizedArrayText`.
 * Same UX as InternationalizedArrayInput but uses a textarea (5 rows) for longer content.
 *
 * Features:
 * - Language tabs with country flags (synced with global context)
 * - Single textarea for the active language
 * - Visual indicator for languages with filled values
 * - Active language synced across all fields and document banner
 */
export function InternationalizedArrayTextInput(
